    ...
    <body>
        ...
        <script type="text/javascript">
            ...
            $('#mytable_filter input')
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "<?php echo site_url('umum/getListImeyPengiriman/' . $idh_pengiriman . '/' . $id_barang . '/' . $is_hp) ?>", "type": "POST"},
                    columns: [
                    {
<?php ($is_hp == 1) ? $id_data = 'idd_pengiriman' : $id_data = 'idimey_pengiriman'; ?>
                    "data": "<?php echo $id_data ?>",
                            "orderable": false
                    },
                    {"data": "view"},
                    {"data": "imey"},
            ...
            title: "Yakin ?",
                    ...
                    $.post("<?php echo site_url(); ?>/umum/deleteDetailPengirimanImey/" + id + "/" + is_hp, function (obj)
                    {
