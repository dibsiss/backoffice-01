                            ...
                            <li class="dropdown user user-menu">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="user-footer">
                                        <div class="pull-left">
                                            <a href="<?php echo site_url('kasir/profile/edit/') . $this->id_user ?>" class="btn btn-default btn-flat">Profile</a>
                                        </div>
            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li><a href="<?= site_url('kasir/customer'); ?>"><i class="fa fa-users"></i> <span>Customer</span></a></li>
                        <li><a href="<?= site_url('kasir/stokTersedia'); ?>"><i class="fa fa-database"></i> <span>Stok Barang</span></a></li>
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="<?= site_url('kasir/tr_retur'); ?>"><i class="fa fa-check" aria-hidden="true"></i>Retur</a></li>
								<li><a href="<?= site_url('umum/lain'); ?>"><i class="fa fa-check" aria-hidden="true"></i>Lain-Lain</a></li>
                                <li><a href="<?= site_url('kasir/retur_customer'); ?>"><i class="fa fa-check" aria-hidden="true"></i>Retur Customer</a></li>
                                <li><a href="<?= site_url('kasir/tr_pengiriman'); ?>"><i class="fa fa-check" aria-hidden="true"></i>Pengiriman</a></li>
                                <li><a href="<?= site_url('kasir/tr_penjualan'); ?>"><i class="fa fa-check" aria-hidden="true"></i>Penjualan</a></li>
                            </ul>
                        </li>
                       <li class="treeview">
