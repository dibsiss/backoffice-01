    ...
    <body>
        ...
        <script type="text/javascript">
            ...
            $('#mytable_filter input')
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "<?php echo site_url('umum/getListImeyRetur/' . $idh_retur . '/' . $id_barang . '/' . $is_hp) ?>", "type": "POST"},
                    columns: [
                    {
<?php ($is_hp == 1) ? $id_data = 'idd_retur' : $id_data = 'idimey_retur'; ?>
            ...
            title: "Yakin ?",
                    ...
                    $.post("<?php echo site_url(); ?>/umum/deleteDetailReturImey/" + id + "/" + is_hp, function (obj)
                    {
