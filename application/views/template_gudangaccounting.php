    ...
    <body class="hold-transition skin-blue sidebar-mini">
        ...
        <div class="wrapper">
            ...
            <header class="main-header">
                <!-- Logo -->
                <a href="<?= site_url('/gudang_accounting/'); ?>" class="logo">
                            ...
                            <li class="dropdown user user-menu">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="user-footer">
                                        <div class="pull-left">
                                            <a href="<?php echo site_url('gudang_accounting/profile/edit/') . $this->id_user ?>" class="btn btn-default btn-flat">Profile</a>
                                        </div>
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        <li class="header">MENU</li>
                         <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="<?= site_url('gudang_accounting/merk'); ?>"><i class="fa fa-check" aria-hidden="true"></i>Merk</a></li>
                                <li><a href="<?= site_url('gudang_accounting/category'); ?>"><i class="fa fa-check" aria-hidden="true"></i>Category</a></li>
                                <li><a href="<?= site_url('gudang_accounting/jenis_non_fisik'); ?>"><i class="fa fa-check" aria-hidden="true"></i>Jenis Non Fisik</a></li>
                                <li><a href="<?= site_url('gudang_accounting/mst_retur'); ?>"><i class="fa fa-check" aria-hidden="true"></i>Status Return</a></li>
                                <li><a href="<?= site_url('gudang_accounting/barang'); ?>"><i class="fa fa-check" aria-hidden="true"></i>Barang</a></li>
                                <li><a href="<?= site_url('gudang_accounting/supliyer'); ?>"><i class="fa fa-check" aria-hidden="true"></i>Supliyer</a></li>
                                <li><a href="<?= site_url('gudang_accounting/toko'); ?>"><i class="fa fa-check" aria-hidden="true"></i>Toko</a></li>
                                <li><a href="<?= site_url('gudang_accounting/gudang'); ?>"><i class="fa fa-check" aria-hidden="true"></i>Gudang</a></li>
                                <li><a href="<?= site_url('gudang_accounting/lain2'); ?>"><i class="fa fa-check" aria-hidden="true"></i>Lain2</a></li>
                            </ul>
                        </li>
                        
                        <!-- Optionally, you can add icons to the links -->
                        <li><a href="<?= site_url('gudang_accounting/stokTersedia'); ?>"><i class="fa fa-database"></i> <span>Stok Barang</span></a></li>
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li class="treeview">
                                    ...
                                    <ul class="treeview-menu">
                                        <li><a href="<?= site_url('gudang_accounting/tr_pengadaan'); ?>"><i class="fa fa-check" aria-hidden="true"></i>Pengadaan</a></li>
                                        <li><a href="<?= site_url('gudang_accounting/inputReturHarga'); ?>"><i class="fa fa-check" aria-hidden="true"></i>Retur Harga</a></li>
                                        <li><a href="<?= site_url('gudang_accounting/inputReturRusak'); ?>"><i class="fa fa-check" aria-hidden="true"></i>Retur Rusak</a></li>
                            ...
                            <ul class="treeview-menu">
                                <li class="treeview">
                                    ...
                                    <ul class="treeview-menu">
                                        <li><a href="<?= site_url('gudang_accounting/tr_pengiriman'); ?>"><i class="fa fa-check" aria-hidden="true"></i>Pengiriman</a></li>
                                        <li><a href="<?= site_url('gudang_accounting/tr_retur'); ?>"><i class="fa fa-check" aria-hidden="true"></i>Retur</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                            <li><a href="<?= site_url('laporan/mutasi_gudang'); ?>"><i class="fa fa-check" aria-hidden="true"></i>Mutasi</a></li>
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><a href="<?= site_url('gudang_accounting/Usergudang'); ?>"><i class="fa fa-check" aria-hidden="true"></i>User Gudang</a></li>
                                <li><a href="<?= site_url('gudang_accounting/Usertoko'); ?>"><i class="fa fa-check" aria-hidden="true"></i>User Toko</a></li>
                            </ul>
                        </li>
