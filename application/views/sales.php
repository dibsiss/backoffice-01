    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
            ...
            <header class="main-header">
                ...
                <!-- Logo -->
                <a href="<?= base_url('/superadmin/template'); ?>" class="logo">
                    <!-- mini logo for sidebar mini 50x50 pixels -->
                    <span class="logo-mini"><b>A</b>LT</span>
                    <!-- logo for regular state and mobile devices -->
                    <span class="logo-lg"><b>Beckoffice</span>
                </a>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="<?= base_url('/superadmin/merk'); ?>"><i class="fa fa-check" aria-hidden="true"></i>Merk</a></li>
                                <li><a href="<?= base_url('/superadmin/category'); ?>"><i class="fa fa-check" aria-hidden="true"></i>Category</a></li>
                                <li><a href="<?= base_url('/superadmin/barang'); ?>"><i class="fa fa-check" aria-hidden="true"></i>Barang</a></li>
                                <li><a href="<?= base_url('/superadmin/supliyer'); ?>"><i class="fa fa-check" aria-hidden="true"></i>Supliyer</a></li>
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="#"><i class="fa fa-check" aria-hidden="true"></i>Stok</a></li>
                        ...
                        <li class="treeview">
                            <a href="#"><i class="fa fa-link"></i> <span>Master Toko</span>
                                <span class="pull-right-container">
                                    <i class="fa fa-angle-left pull-right"></i>
                                </span>
                            </a>
                            <ul class="treeview-menu">
                                <li><a href="#"><i class="fa fa-check" aria-hidden="true"></i>Toko</a></li>
                                <li><a href="#"><i class="fa fa-check" aria-hidden="true"></i>Gudang</a></li>
                            </ul>
                        </li>
                        <li class="treeview">
                            <a href="#"><i class="fa fa-link"></i> <span>Master User</span>
                                <span class="pull-right-container">
                                    <i class="fa fa-angle-left pull-right"></i>
                                </span>
                            </a>
                            <ul class="treeview-menu">
                                <li><a href="<?= base_url('/superadmin/User'); ?>"><i class="fa fa-check" aria-hidden="true"></i>User</a></li>
                                <li><a href="<?= base_url('/superadmin/Usergudang'); ?>"><i class="fa fa-check" aria-hidden="true"></i>User Gudang</a></li>
                                <li><a href="<?= base_url('/superadmin/Usertoko'); ?>"><i class="fa fa-check" aria-hidden="true"></i>User Toko</a></li>
                                <li><a href="<?= base_url('/superadmin/toko'); ?>"><i class="fa fa-check" aria-hidden="true"></i>Toko</a></li>
                                <li><a href="<?= base_url('/superadmin/gudang'); ?>"><i class="fa fa-check" aria-hidden="true"></i>Gudang</a></li>
                            </ul>
                        </li>
                    </ul>
                    <!-- /.sidebar-menu -->
