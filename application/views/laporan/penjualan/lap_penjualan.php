            ...
            <div class="box box-primary">
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div class="radio" >
                            <label>
                                <input name="status_fisik" id="radio-default" value="semua" checked type="radio">Semua
                            </label>
                            <label>
                                <input name="status_fisik" value="fisik" type="radio">Fisik
                            </label>
                            <label>
                                <input name="status_fisik" value="elektrik" type="radio">Elektrik
                            </label>
                        </div>
                    </div>
                   <div class="form-group">
                        ...
                        <div class="radio" >
                            <label>
                                <input name="jenis_barang" id="radio-default2" value="semua" checked type="radio">Semua
                            </label>
                            <label>
            ...
            <div class="box box-primary">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <select name="id_customer" id="id_customer" class="chosen-select-deselect" data-placeholder='Pilih Customer' style='width:100%'>
                            <?php
                            echo cmb_customer();
                            ?>
                        </select>
...
<script type="text/javascript">
    function cari() {
        ...
        $.post("<?php echo site_url(); ?>/laporan/penjualanRentang/", datastring, function (result)
        {
