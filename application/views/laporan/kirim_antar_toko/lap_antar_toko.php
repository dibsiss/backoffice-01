        ...
        <div class="col-md-4">
            <div class="box box-primary">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label>Sumber:</label>
                        <select name="id_toko_sumber" id="id_toko_sumber" class="chosen-select-deselect" data-placeholder='Pilih Toko Sumber' style='width:100%'>
                            <?php
                            echo cmb_antar_toko();
                            ?>
                        </select>
		...
		<div class="col-md-4">
            <div class="box box-primary">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label>Tujuan:</label>
                        <select name="id_toko_tujuan" id="id_toko_tujuan" class="chosen-select-deselect" data-placeholder='Pilih Toko Tujuan' style='width:100%'>
                            <?php
                            echo cmb_antar_toko();
                            ?>
                        </select>
...
<script type="text/javascript">
    function cari() {
        ...
        $.post("<?php echo site_url(); ?>/laporan/prosesAntarToko/", datastring, function (result)
        {
