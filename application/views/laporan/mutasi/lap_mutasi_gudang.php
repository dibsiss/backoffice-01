        ...
        <div class="col-md-4">
            <div class="box box-primary">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label>Barang :</label>
                        <select name="id_barang" id="id_barang" class="chosen-select-deselect" data-placeholder='Pilih Barang' style='width:100%'>
                            <?php
                            echo cmb_mst_barang_mutasi_gudang();
                            ?>
                        </select>
                    </div><!-- /.form group -->    
...
<script type="text/javascript">
    function cari() {
        ...
        $.post("<?php echo site_url(); ?>/laporan/prosesMutasi/", datastring, function (result)
        {
